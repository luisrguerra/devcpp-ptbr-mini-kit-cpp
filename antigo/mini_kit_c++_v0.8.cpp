...
// double double_ex;      // ponto flutuante de dupla precisao
 ...
 int main(){
  ...
  cout << "Acordei" << endl;
  cout << "Representado uma aspas dupla dentro de uma string:"<<  " \" " << endl << endl;
  ...
  cout << endl << "Criando uma pasta pasta_exemplo" << endl;
  cout << "Se já ouver uma pasta o cmd do Windows avisará" << endl;
  ...
  cout << "Se já ouver um arquivo com o mesmo nome o cmd do Windows avisará" << endl;
  ...
  int janela_sim_nao_notepad = MessageBox( 0, "Deseja abrir o arquivo texto_renomeado.txt no bloco denotas do Windows?", "Notepad", MB_YESNO );
